...
$_getC = $dbComObj->viewData($conn,"order_detail", "*","1 and (status='3' or status='6') order by id DESC");    
$dataAtOne = 10;
$mainPagination = "";
$data = $_REQUEST;
...
<div id="page-content">
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-notes_2"></i>Manage Complete Order List <br><small>Complete Order Details!</small>
            </h1>
        </div>
                    ...
                    <div class="x_content">
                        ...
                        <div class="table-responsive">                            
                            <table id="countryTable" class="table table-vcenter table-condensed table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $result = $dbComObj->viewData($conn, "order_detail", "*", "1 and (status='3' or status='6') order by id DESC " . $mainPagination);
